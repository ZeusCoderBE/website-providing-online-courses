				...
				<div class="form-list">
					<div class="form-item">
						<div class="form-item-login">
							...
							<div class="form-login-input">
								<label for="gv">Giảng viên</label> <input type="text"
									id="tengiangvien" name="tengiangvien"
									placeholder="Tên giảng viên" required /> <label for="price">Gia
									tiền:</label> <input type="text" id="giatien" name="giatien"
									placeholder="vd: $9999" required />
							</div>
							<div class="form-login-input">
								<label for="gv">Trình độ </label> <input type="text"
									id="trinhdodauvao" name="trinhdodauvao"
									placeholder="Tên giảng viên" required /> <label for="price">Đánh
									Giá</label> <input type="text" id="danhgia" name="danhgia"
									placeholder="vd: 5" required />
							</div>
							<div class="form-login-input">
								<label for="makh">Ngôn ngữ</label> <input type="text"
									id="ngonngu" name="ngonngu" placeholder="vd: C#" /> <label
									for="gv">Thời lượng</label> <input type="text" id="thoiluong"
									name="thoiluong" placeholder="vd: 1:00:00" />
							</div>
							<div class="form-login-input">
								<label for="makh">Lĩnh Vực</label> <input type="text"
									...
									id="ngayphathanh" name="ngayphathanh" placeholder="vd: 1:00:00" />
							</div>
