						...
						<div class="form-item-login">
							...
							<div class="form-container">
								<div class="form-control">
									...
									<div class="form-login-input">
										<label for="makh">Thể lọai</label> <input type="text"
											id="theloai" name="theloai" placeholder="Thể loại" required
									...
									<div class="form-login-input">
										<label for="makh">Lĩnh Vực</label> <input type="text"
											...
											value="${findkhoahoc.linhvuc}" />
									</div>
									<div class="form-login-input">
										<label for="gv">Ngày phát hành</label> <input type="date"
