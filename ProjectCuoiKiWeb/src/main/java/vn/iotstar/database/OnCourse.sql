...
CREATE TABLE GIOHANG (
	...
	CONSTRAINT FK_GIOHANG_NGUOIDUNG FOREIGN KEY (MaNguoiDung) REFERENCES HocVien(MaHocVien) ,
...
CREATE TABLE DANGKY (
	...
	PRIMARY KEY (MaNguoiDung, MaKhoaHoc),
	CONSTRAINT FK_DANGKY_NGUOIDUNG FOREIGN KEY (MaNguoiDung) REFERENCES HocVien(MaHocVien),
...
CREATE TABLE THANHTOAN (
	...
	PRIMARY KEY (MaNguoiDung, MaKhoaHoc),
	CONSTRAINT FK_THANHTOAN_NGUOIDUNG FOREIGN KEY (MaNguoiDung) REFERENCES HocVien(MaHocVien),
...
CREATE TABLE HOC (
	...
	CONSTRAINT FK_HOC_NGUOIDUNG FOREIGN KEY (MaNguoiDung) REFERENCES HocVien(MaHocVien),
...
CREATE TABLE LAMBAITAP (
	...
	CONSTRAINT FK_LAMBAITAP_NGUOIDUNG FOREIGN KEY (MaNguoiDung) REFERENCES HocVien(MaHocVien),
