...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <h3 class="text-center text-secondary mt-5 mb-3">Đăng ký</h3>
            <form action = "/006_JSP/InsertStudent" method = "post" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 bg-light">
                ...
                <div class="form-group">
                    <button class="btn btn-success px-5">Đăng ký</button>
                </div>
            </form>
